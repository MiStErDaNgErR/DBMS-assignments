...
Customer_ID VARCHAR(20) NOT NULL ,
Vehicle_id varchar(50) not null,
CONSTRAINT PRIMARY KEY GRP6_____PREMIUM_PAYMENT (Premium_Payment_Id,Customer_ID,Vehicle_Id),
CONSTRAINT  FOREIGN KEY (Customer_ID) REFERENCES grp6_____customer (Customer_ID),
CONSTRAINT  FOREIGN KEY (Vehicle_Id) REFERENCES grp6_____vehicle (Vehicle_Id)

);
CREATE UNIQUE index PREMIUM_PAYMENT ON GRP6_____PREMIUM_PAYMENT (Premium_Payment_Id ASC);
...
Agreement_Id VARCHAR(20) NOT NULL ,
Claim_Amount VARCHAR(500)NOT NULL ,
...
company_id VARCHAR(200) NOT NULL , 
CONSTRAINT GRP6_____OFFICE PRIMARY KEY(Office_Name,Department_Name,company_id),
CONSTRAINT  FOREIGN KEY (Department_Name,Department_ID,company_id) REFERENCES grp6_____department (Department_Name,Department_ID,Company_id) ON DELETE CASCADE ON UPDATE CASCADE
);
